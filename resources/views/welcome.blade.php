...
@section('content')
    <div class="d-flex justify-content-center align-items-center form" style="height: 100vh; width: 100%">
        <form class="p-5" action="{{route('cases.store')}}" method="POST">
            ...
            <p class="text-center mb-3">يرجى تحديد المعلومات بدقة كبيرة لمساعدتنا في ربط المعلومات مع الجهات المختصة وتحديدها على الخريطة بدقة</p>
        ...
        @if ($errors->any())
            ...
            <div class="form-group">
                <label for="name">الاسم الثلاثي متطوع او طبيب او مهندس\اسم الجهة\اسم الفريق\اسم المركز <span style="color: red">* </span></label>
            ...
            <div class="form-group">
                <label for="case-description">وصف الحالة\وصف البناء\ وصف امكانيات الفريق او نطاق عمله\ وصف طاقة المراكز الطبية   </label>
